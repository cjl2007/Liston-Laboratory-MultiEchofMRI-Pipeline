function neighbors = cifti_neighbors(ciftifile,resource_dir)
...
bufsize=16384;
surfneighborfile = [resource_dir '/node_neighbors.txt'];
% Read in node neighbor file generated from caret -surface-topology-neighbors
[surfneighbors(:,1) surfneighbors(:,2) surfneighbors(:,3) surfneighbors(:,4) surfneighbors(:,5) surfneighbors(:,6) surfneighbors(:,7)] = textread(surfneighborfile,'%u %u %u %u %u %u %u','delimiter',' ','bufsize',bufsize,'emptyvalue',NaN);
