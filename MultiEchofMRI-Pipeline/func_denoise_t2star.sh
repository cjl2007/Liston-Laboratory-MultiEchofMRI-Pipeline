...
wb_command -cifti-smoothing "$Subdir"/func/t2star/T2star.dtseries.nii "$SurfaceSmoothingSigma" "$SurfaceSmoothingSigma" COLUMN "$Subdir"/func/t2star/T2star_s"$SurfaceSmoothingSigma".dtseries.nii \
-left-surface "$Subdir"/anat/T1w/fsaverage_LR32k/"$Subject".L.midthickness.32k_fs_LR.surf.gii -right-surface "$Subdir"/anat/T1w/fsaverage_LR32k/"$Subject".R.midthickness.32k_fs_LR.surf.gii 
