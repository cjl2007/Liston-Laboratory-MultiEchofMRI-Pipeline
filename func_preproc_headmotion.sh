...
func () {
	...
	for e in $(seq 1 1 "$n_te") ; do
		...
		"$2"/func/rest/"$3"/Rest_E"$e"_nonlin.nii.gz # note: this step reduces file size by setting non brain voxels to zero, which is generally desirable but not absolutely needed.
